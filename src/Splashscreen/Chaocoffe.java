 ...
 * @author Asus k550j
 */
public class Chaocoffe extends javax.swing.JDialog {
    /**
     * Creates new form WelcomeJDialog
     */
    public Chaocoffe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hinhanh/hinhcafe11.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Chaocoffe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Chaocoffe dialog = new Chaocoffe(new javax.swing.JFrame(), true);
